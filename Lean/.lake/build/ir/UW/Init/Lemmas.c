...
// Module: UW.Init.Lemmas
// Imports: Init UW.Init.Set UW.Init.Graph UW.Init.Tree
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_UW_Init_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;
